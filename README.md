...
* ⚡ Instant Results – Display conversion results dynamically.
* 🔁 Unit Switching – Easily change the conversion direction.
* 🧮 Conversion Logic – Perform calculations based on selected units.
* 🎨 Jetpack Compose UI – Modern declarative Android interface.
* 📱 User-Friendly Design – Simple and intuitive conversion workflow.
